...
map.getView().fit([8524275.702697, 1202834.073827, 8540471.810068, 1212111.609427], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PALAKKAD ADMINISTRATIVE MAP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (187 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Palakkad is one of the fourteen districts of Kerala and has no coastal line. The district opens the state to the rest of the country through the Palakkad Gap with a width of 32 to 40 Kms.';
            }
